...
@Component({
  selector: 'app-init-test-tree',
  templateUrl: './init-test-tree.component.html',
  styleUrls: ['./init-test-tree.component.css']
})
export class InitTestTreeComponent implements OnInit {
  files: TreeNode[];
